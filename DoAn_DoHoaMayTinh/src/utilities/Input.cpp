...
void Input::Update(GLFWwindow *window) {
    ...
    for (int i = 0; i < GLFW_MOUSE_BUTTON_8; ++i) {
        if (glfwGetMouseButton(window, i) == GLFW_PRESS) {
            //Nếu trạng thái của nút i trả ra từ window là press
            //Trạng thái chưa press => press
            //Trạng thái đã press => hold
            ...
            //Nếu trạng thái của nút i trả ra từ window không phải press
            //Trạng thái đã press hoặc hold => release
            //Trạng thái chưa press => free
